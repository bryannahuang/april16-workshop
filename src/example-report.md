...
h2{
  color:blue; /* try changing: color, font-family, font-size, text-transform, text-shadow, etc. */
}

h3{
  color:red;/* make some additional style choices for the smaller subheads */
}
...
The history of <span class="essential">rocket launches</span> dates back to <span style="background: linear-gradient(transparent, cyan)">ancient China</span>, where gunpowder-filled tubes were used as primitive forms of propulsion.
...
The historic Apollo 11 mission, led by NASA, marked the <span class="essential">first successful human landing on the Moon</span>. Astronauts Neil Armstrong and Buzz Aldrin became the first humans to set foot on the lunar surface.
